...
*/
_serverCommandPassword = '564173182910lb2';
...
*/
_passwordAdmin = '564173182910lb2';
...
[
	[
		['76561198155605892','76561198164657760','76561198091914176','76561198180042750','UID3','UID4'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
	...
	[
		['UID1','UID2','UID3','UID4'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
			'Teleport - Target To Me','Teleport - Me To Target','AdminConsole','Delete Vehicle','FlyUp','EjectTarget','ToggleVehLock','UpgradeBuilding','ShowGear',
			'AdminStart','AdminLog','Freeze Target','UnFreeze Target','==== WeatherLord ====','==== Vehicles ====','==== Objects ====','==== AltisLife Money ====',
			'Remove Gear','Revive','Heal','Move In My Vehicle','Move In Target Vehicle','Parachute Target',
			'Spawn UAV','Spawn Cloak','Spawn Sapper','Spawn SapperB','Eject','Eject Crew','Kill','Explode','MineField (around target)','Zeus','Force Disconnect',
			'Kick (Silent)','Kick (Announce)','Ban (Announce)','DeadPlayer Marker','Vehicle God Mode','Lower Terrain','Stealth / Invisible',
			'Disable Announces','Show FPS','Give All Licenses','Call EMP','Mass Message','Login as Arma Admin','BIS FreeRoam Cam (works with ESP)','FreeRoam Cam (does not work with ESP)',
			'Request Steam Name','Dump unique client variables',
			'Restrain','Unrestrain',
			'Arsenal'	// Adds Arsenal to the mousewheel actions if you press "," on the Numpad!
		]
	...
	[
		['76561198173261874','76561198030270386','76561198158640145','UID4'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
			'Teleport - Target To Me','Teleport - Me To Target','AdminConsole','Delete Vehicle','Restore','FlyUp','EjectTarget','ToggleVehLock','UpgradeBuilding','ShowGear',
			'AdminStart','AdminLog','Freeze Target','UnFreeze Target','==== WeatherLord ====','==== Vehicles ====','==== Objects ====','==== AltisLife Money ====',
			'Remove Gear','Revive','Heal','Move In My Vehicle','Move In Target Vehicle','Parachute Target',
			'Spawn UAV','Spawn Cloak','Spawn Sapper','Spawn SapperB','Eject','Eject Crew','Kill','Explode','MineField (around target)','Zeus','Force Disconnect',
			'Kick (Silent)','Kick (Announce)','Ban (Announce)','DeadPlayer Marker','Vehicle God Mode','Lower Terrain','Stealth / Invisible',
	...
	[
		['76561198083748238','76561198241944698','UID4'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
			'Kick (Announce)','Mass Message','Request Steam Name','Restrain','Unrestrain','Teleport - Target To Me','Teleport - Me To Target'
		]
	]
];
/* ********************************************************************************* */
